...
SIESTA_ARCH = x86_64-honpas-linux-intel
...
CFLAGS_OPTIM = -O0
CFLAGS = -g -debug all -fPIC -fno-omit-frame-pointer -fp-model source $(CFLAGS_OPTIM)

# Here we should put mainly optimization flags for C++
CXXFLAGS_OPTIM = -O0
CXXFLAGS = -g -debug all -fPIC -fno-omit-frame-pointer -fp-model source $(CXXFLAGS_OPTIM)
CXX_LIBS = -lstdc++

# Here we should put mainly optimization flags for Fortran
FFLAGS_OPTIM = -O0
FFLAGS = -g -fPIC -check all -debug all -fno-omit-frame-pointer -fp-model source -fpe0 -implicitnone -init=snan -traceback $(FFLAGS_OPTIM)
...
#BLACS_LIBS = -lblacs-openmpi -lblacsCinit-openmpi -lblacsF77init-openmpi
...
#NETCDF_INCFLAGS = -I/usrlocal/include
#NETCDF_LIBS = /usr/local/lib/libnetcdff.a /usr/local/lib/libnetcdf.a
