...
CFLAGS_OPTIM = -O2 -axSSE4.2,AVX
CFLAGS = -g -fPIC -fp-model source $(CFLAGS_OPTIM)

# Here we should put mainly optimization flags for C++
CXXFLAGS_OPTIM = -O2 -axSSE4.2,AVX
CXXFLAGS = -g -fPIC -fp-model source $(CXXFLAGS_OPTIM)
CXX_LIBS = -lstdc++

# Here we should put mainly optimization flags for Fortran
FFLAGS_OPTIM = -O2 -axSSE4.2,AVX
FFLAGS = -g -fPIC -fp-model source $(FFLAGS_OPTIM)
...
# to work with VPATH.
#
FFLAGS_DEBUG = -g -fPIC -fp-model source -traceback -O0
