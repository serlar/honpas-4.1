...
CFLAGS_OPTIM = -O0
CFLAGS = -g3 -ggdb -fPIC -fno-omit-frame-pointer $(CFLAGS_OPTIM)

# Here we should put mainly optimization flags for C++
CXXFLAGS_OPTIM = -O0
CXXFLAGS = -g3 -ggdb -fPIC -fno-omit-frame-pointer -std=c++11 $(CXXFLAGS_OPTIM)
CXX_LIBS =

# Here we should put mainly optimization flags for Fortran
FFLAGS_OPTIM = -O0
FFLAGS = -g3 -ggdb -fPIC -fbacktrace -fcheck=bounds,do,mem,pointer,recursion -fimplicit-none -finit-real=snan -fno-automatic -fno-omit-frame-pointer $(FFLAGS_OPTIM)
